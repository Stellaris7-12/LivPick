...
class SeckillHttpBenchmarkTest {

    @Test
    void runBenchmark() throws Exception {
        Assumptions.assumeTrue(Boolean.getBoolean("benchmark.run"));
    ...
    private BenchmarkResult execute(String baseUrl, long voucherId, int totalRequests, int concurrency, long userIdStart)
